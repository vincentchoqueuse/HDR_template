...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[xshift=0.08\paperwidth,yshift=0cm] {
  \includegraphics[width=7cm]{\@logoecoledoc}
  };
  \fi
  }
  
  \node[xshift=.7\paperwidth,yshift=0cm] {
  \includegraphics[width=3.5cm]{\@logoetablissement}
  };
\end{tikzpicture}
\par\nobreak
}
...
\begin{spacing}{1}
        \vspace{3cm}
        {\LARGE \textsc{Habilitation à Diriger des Recherches de}} \par
        \vspace{2.5cm}
        ...
        \hspace{0cm}Par \par
        \vspace{0.25cm}
        \hspace{0cm}{\LARGE\textbf{\@author}} \par
        \vspace{1cm}
        ...
        \vspace{0.2cm}
        \small
        \textbf{Habilitation pr{\'e}sent{\'e}e et soutenue {\`a} \@lieusoutenance, le \@datesoutenance} \par
